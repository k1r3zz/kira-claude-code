...
<!--
  ...
  When this module needs splitting (>150 lines), use:
  - references/module-index-template.md — replaces this file as module index
  - references/module-subfile-template.md — for each sub-topic file
-->
